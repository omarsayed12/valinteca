!(function (a, b, c, d) {
  ...
  (function (a, b, c, d) {
    ...
    (e.Defaults = {
      nav: !1,
      navText: [
        '<span aria-label="Previous" class="nav-slide-arrow nav-slide-arrow-next">&#x2039;</span>',
        '<span aria-label="Next Previous" class="nav-slide-arrow nav-slide-arrow-pre">&#x203a;</span>',
      ],
      navSpeed: !1,
      ...
      (e.prototype.initialize = function () {
        ...
        (this._controls.$relative = (
          ...
          c.dotsData ||
            (this._templates = [
              a('<button role="button" aria-label="slider dots">')
                .addClass(c.dotClass)
                .append(a("<span>"))
                .prop("outerHTML"),
            ]),
